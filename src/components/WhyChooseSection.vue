<template>
  <div>
    <!-- Desktop layout -->
    <section class="hidden md:block py-16 px-4 bg-secondary-light">
          ...
          >
            <div>
              ...
              <h3
                ...
                :class="benefit.highlighted ? 'text-primary' : 'text-white'"
              >
                {{ benefit.title }}
              </h3>
          ...
          >
            ...
            <div class="flex-1">
              <h3
                ...
                :class="benefit.highlighted ? 'text-[#01A9AC]' : 'text-white'"
              >
                {{ benefit.title }}
              </h3>
              <p
...
defineProps({
  sectionData: {
    ...
    default: () => ({
      ...
      subtitle:
        "Trust BioDigestin™ for daily gut wellness — backed by science, inspired by nature",
      benefits: [
        {
